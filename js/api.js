...
const ErrorText = {
  GET_DATA: 'Не удалось загрузить данные. Попробуйте обновить страницу', // Текст ошибки при получении данных
  SEND_DATA: 'Не удалось отправить форму. Попробуйте еще раз', // Текст ошибки при отправке данных
};
